...
import { Loader2, Plus, Trash2, Pencil, X, Check, AlertCircle, Eye, EyeOff } from "lucide-react";
...
const EMPTY = { title: "", slug: "", excerpt: "", content: "", isPublished: true };
const inputClass =
...
export default function AdminBlogPage() {
  ...
  async function load() {
    ...
    setError(null);
    try {
      setItems(await adminFetch<PostRow[]>("/blog/admin/all"));
    } catch (err: any) {
      ...
      {editingId !== null && (
        <div className="mt-6 space-y-3 rounded-sm border border-border bg-surface p-5">
          ...
          <label className="flex items-center gap-2 font-mono text-xs text-muted">
            ...
            />
            የታተመ (ካልተመረጠ እንደ ረቂቅ ብቻ ይቀመጣል፣ በ website ላይ አይታይም)
          </label>
            ...
            <div key={item.id} className="flex items-start justify-between gap-4 p-4">
              ...
              <div className="flex shrink-0 gap-2">
                <button
                  ...
                  title={item.isPublished ? "ወደ ረቂቅ ቀይር" : "አትም"}
                >
